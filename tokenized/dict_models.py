...
class LongMatchingTokenizer(BaseTokenizer):
    def __init__(self, 
    bi_grams_path='C:/Users/locng/Documents/webs/natural-language-processing/tokenized/bi_grams.txt', 
    tri_grams_path='C:/Users/locng/Documents/webs/natural-language-processing/tokenized/tri_grams.txt'):
        """
        Initial config
